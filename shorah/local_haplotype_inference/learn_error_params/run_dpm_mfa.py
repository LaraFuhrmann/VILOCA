...
def main(freads_in, fref_in, output_dir, n_starts, K, alpha0, alphabet="ACGT-", make_unique_reads=False, convergence_threshold = 1e-03):
    ...
    reads_list = preparation.load_fasta2reads_list(freads_in, alphabet, make_unique_reads)
